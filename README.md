...
[![build status](https://img.shields.io/github/actions/workflow/status/VFLins/nflogic/tests.yml?branch=main&label=tests&style=for-the-badge)](https://github.com/VFLins/nflogic/tree/main/tests)
